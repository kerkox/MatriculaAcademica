 ...
 * @author atenea
 */
public class ProgramarCurso2 extends javax.swing.JFrame {
    ...
    private ProgramarCurso2 proCurso = this;
    private Principal main;
    private Cupo cupo;
    private HorariosCurso horariosUI = null;
    private boolean save = false;
    
    public ProgramarCurso2(Docente docente, Universidad u, Principal main) {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Cancelar Curso", jTabbedPane2);
        jTabbedPane1.addTab("Modificar Curso", jTabbedPane3);
