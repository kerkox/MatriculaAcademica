...
public class CursosProgramados extends javax.swing.JFrame {
    ...
    public CursosProgramados(Periodo periodo) {
        ...
        this.TableCursoStudent.setModel(new AbstractTableModel() {
            ...
            private String[] nombres = {"Codigo", "Nombre Asignatura", "Creditos", "intensidad", "Docente"};
            private List<Curso> cursos =periodo.getCursos();
...
//            setVisible(false);
            JOptionPane.showMessageDialog(null, "Todavia esta en Desarrollo");
        }
